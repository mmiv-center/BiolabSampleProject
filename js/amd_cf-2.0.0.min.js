...
c(Error("Must inlcude x_values as an property on data"))})};l=function(a){return k[a]?k[a]:q(a)};q=function(a){var c,b,d,f;c=[];b=Object.create(Promise);d=function(a){eq = eval("eq = "+a);return eq};(function(){var c,e;c=function(b,c){return function(r){var e,g;e=d(r);g=m(e,a);g[0]?(f=r,b(e)):(console.error(g[1]),c(g[1]))}};e=function(b){return function(c){b(Error("Failed to get: "+a+" statusText: "+c.statusText+" status: "+c.status))}};b.equation=new Promise(function(b,d){jQuery.ajax({dataType:"text",url:a,
